            ...
            >
              <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 16 }}>
                <MagneticButton
                  ...
                  onClick={() => trackEvent('Download', 'App Store Click', 'Footer')}
                ...
                <MagneticButton
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackEvent('Download', 'Google Play Click', 'Footer')}
                  className="footer-pill-primary"
                  style={pillLink}
                >
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(213,230,235,0.7)' }}>
              ...
              <nav aria-label="DermaScope.ai social media" className="footer-social" style={{ marginTop: 4 }}>
                <a href="https://www.facebook.com/people/Derma-Scope/61590508775513/" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('Social', 'Facebook Click')} aria-label="DermaScope.ai on Facebook" className="footer-social-link">
                ...
                <a href="https://www.instagram.com/dermascope.ai/" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('Social', 'Instagram Click')} aria-label="DermaScope.ai on Instagram" className="footer-social-link">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
                ...
                <a href="https://x.com/Derma_Scope" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('Social', 'X Click')} aria-label="DermaScope.ai on X" className="footer-social-link">
