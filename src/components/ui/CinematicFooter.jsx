          ...
          >
            ...
            >
              ...
              <nav aria-label="DermaScope.ai social media" className="footer-social" style={{ marginTop: 4 }}>
                <a href="https://www.facebook.com/people/Derma-Scope/61590508775513/" target="_blank" rel="noopener noreferrer" aria-label="DermaScope.ai on Facebook" className="footer-social-link">
                ...
                <a href="https://www.instagram.com/dermascope.ai/" target="_blank" rel="noopener noreferrer" aria-label="DermaScope.ai on Instagram" className="footer-social-link">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
                ...
                <a href="https://x.com/Derma_Scope" target="_blank" rel="noopener noreferrer" aria-label="DermaScope.ai on X" className="footer-social-link">
